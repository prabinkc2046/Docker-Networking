...
Once the containers are up and running, you can access the "Myapp" application by opening a web browser and visiting http://localhost:5000. You should see the following page:
	...
	![Myapp Running APP](https://github.com/prabinkc2046/Docker-Networking/blob/main/Myapp%20is%20running.png)
...
You should see the following page:
	...
	![(https://github.com/prabinkc2046/Docker-Networking/blob/main/Myapp%20is%20running.png)
